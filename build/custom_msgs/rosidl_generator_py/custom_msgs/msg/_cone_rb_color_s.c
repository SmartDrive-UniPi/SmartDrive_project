...
bool custom_msgs__msg__cone_rb_color__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._cone_rb_color.ConeRBColor", full_classname_dest, 42) == 0);
  }
  custom_msgs__msg__ConeRBColor * ros_message = _ros_message;
  {  // range
...
{
  /* NOTE(esteve): Call constructor of ConeRBColor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._cone_rb_color");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ConeRBColor");
